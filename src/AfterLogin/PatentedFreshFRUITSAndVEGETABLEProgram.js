...
export default class PatentedFreshFRUITSAndVEGETABLEProgram extends React.Component {

    static navigationOptions = ({ navigation }) => ({
        headerTitle: <NavTitle name="Patented Fresh FRUITS And VEGETABLE Program" />,
    ...
    PatentFoodApiCall() {
        ...
        new Promise((resolve, reject) => {
            Api.post("api_patent-food.php", data)
                .then((response) => {
