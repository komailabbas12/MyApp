...
export default class NeedEmergencyFood extends React.Component {

    static navigationOptions = ({ navigation }) => ({
        headerTitle: <NavTitle name="Need Emergency Food" />,
    ...
    NeedEmergencyFoodApiCall() {
        ...
        new Promise((resolve, reject) => {
            Api.post("api_need_emergency_food.php", data)
                .then((response) => {
