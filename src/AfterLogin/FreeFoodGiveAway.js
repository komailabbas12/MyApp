...
export default class FreeFoodGiveAway extends React.Component {

    static navigationOptions = ({ navigation }) => ({
        headerTitle: <NavTitle name="Free Food Give Away" />,
    ...
    FreeFoodGiveAwayApiCall() {
        ...
        new Promise((resolve, reject) => {
            Api.post("api_free_food_give_away.php", data)
                .then((response) => {
