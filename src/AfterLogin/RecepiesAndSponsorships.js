...
export default class RecepiesAndSponsorships extends React.Component {

    static navigationOptions = ({ navigation }) => ({
        headerTitle: <NavTitle name="Recipes and Sponsorships" />,
    ...
    async _bootstrapAsync() {
        this.RecepiesAndSponsorShipsApiCall()
    };
    ...
    RecepiesAndSponsorShipsApiCall() {
        ...
        new Promise((resolve, reject) => {
            Api.post("api_recepies_and_sponsorships.php", data)
                .then((response) => {
